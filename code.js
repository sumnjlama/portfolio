function hover(element) {
    element.setAttribute('src', 'imgs/icons/git-icn-dark.svg')
}

function unhover(element) {
    element.setAttribute('src', 'imgs/icons/behance icon 1.svg')
}

function openSite1() {
    let openJhr = window.open("https://www.jhrnaturecure.com/");
}
function openSite2() {
    let openSnowdonia = window.open("https://sumnjlama.github.io/projectSnowdon/index.html");
}
function openSite3() {
